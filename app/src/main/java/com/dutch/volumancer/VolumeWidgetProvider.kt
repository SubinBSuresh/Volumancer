...
class VolumeWidgetProvider : AppWidgetProvider() {
    ...
    private fun updateWidget (context: Context?, widgetManager: AppWidgetManager, widgetId: Int) {
        ...
        views.setOnClickPendingIntent(R.id.btn_widgetPlus, PendingIntent.getBroadcast(context, 0, upIntent,
            PendingIntent.FLAG_IMMUTABLE
        ))

        views.setOnClickPendingIntent(R.id.btn_WidgetMinus, PendingIntent.getBroadcast(context, 1, downIntent,
            PendingIntent.FLAG_IMMUTABLE
        ))

        views.setOnClickPendingIntent(R.id.tv_widgetMedia, PendingIntent.getBroadcast(context, 2, quickBall,
            PendingIntent.FLAG_IMMUTABLE))
